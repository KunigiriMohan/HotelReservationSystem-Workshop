...
public class HotelReservation {
    ...
    /*
     * add() method to add hotel details to various maps
     * */
    public int add(String hotel_name,int rate_Regular_Weekdays,int weekEnd_Fare,int rating)    //adding rating
    {
        hotels.put(hotel_name,new Hotel(hotel_name,rate_Regular_Weekdays,weekEnd_Fare,rating));
